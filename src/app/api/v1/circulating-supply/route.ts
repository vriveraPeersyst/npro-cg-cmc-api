...
/**
 * GET /api/v1/circulating-supply
 *
 * Returns the circulating supply as a plain number.
...
export async function GET() {
    try {
        ...
        return new NextResponse(supplies.circulating_supply.toString(), {
            status: 200,
            headers: {
        ...
        logger.error({ err }, "failed to serve circulating supply");
